...
plot_desc_stats_CP_vs_RoC(desc_stats, "C_com_entropy", "LP_entropy")
...
plot_desc_stats_CP_vs_RoC(desc_stats, "C_com_median", "C_com_entropy")
plot_desc_stats_CP_vs_RoC(desc_stats, "CP_median", "CP_entropy")
plot_desc_stats_CP_vs_RoC(desc_stats, "LP_median", "LP_entropy")
plot_desc_stats_CP_vs_RoC(desc_stats, "RoC_median", "RoC_entropy")
